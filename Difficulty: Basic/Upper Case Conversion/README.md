<h2><a href="https://www.geeksforgeeks.org/problems/upper-case-conversion5419/1?sortBy=&category%5B%5D=Strings&page=3&difficulty%5B%5D=-2">Upper Case Conversion</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>s</strong>,&nbsp;convert the first letter of each word in the string to uppercase.&nbsp;</span></p>
