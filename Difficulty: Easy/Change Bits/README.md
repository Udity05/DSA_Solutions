<h2><a href="https://www.geeksforgeeks.org/problems/change-bits1538/1?sortBy=&category%5B%5D=Numbers&page=1&difficulty%5B%5D=-2">Change Bits</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N,</strong>&nbsp;complete the following&nbsp;tasks,<br>
